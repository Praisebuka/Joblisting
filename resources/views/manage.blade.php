...
<script src="//unpkg.com/alpinejs" defer></script>
    ...
    <body>
        ...
        <div class="min-w-full relative border-2 relative border-gray box-content block border-rounded overflow-hidden p-12 mb-6 flex hover:border-indigo-500 w-screen shadow-lg shadow-blacks w-full ">
        ...
        <div class="w-full">
           <a href="/{{$list->id}}"> <h2 class="text-2xl text-black  " >{{$list->title}}</h2></a>
            <div class="m-4 object-right">
             ...
             @csrf
             @method('DELETE')
             <button type="submit" class="  right-0  justify-center relative py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700">Delete this job</button>
              <a href="/{{$list->id}}/edit" class="py-2  px-4 bg-gray-900 text-white border border-transparent rounded-md">Edit Job</a>
           </form> </div>
        </div> 
        </div>
      </a>
